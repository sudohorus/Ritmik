...
export default function BizarreListenerDecorationModal({ user, onClose }: BizarreListenerDecorationModalProps) {
    ...
    const previewDecoration = {
        ...
        description: 'Awarded to early beta testers',
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-300">
                <div className="relative px-6 py-6 text-center border-b border-zinc-800 bg-linear-to-b from-purple-950/30 to-transparent">
                    <button
                        onClick={onClose}
                    ...
                    <h2 className="text-2xl font-bold text-white mb-1">Beta Reward Unlocked!</h2>
                    <p className="text-purple-400 text-sm font-medium">Bizarre Listener</p>
                </div>
                ...
                <div className="px-6 py-6 space-y-6">
                    ...
                    <div className="text-center space-y-2">
                        <p className="text-zinc-300 text-sm">
                            Thank you for being an early supporter of Ritmik!
                            As a Beta Tester, you've unlocked this exclusive avatar decoration.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-3">
                        <button
                            ...
                            disabled={claiming}
                            className="w-full px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-purple-900/20"
                        >
